...
function follow()
{
	var glass=document.getElementsByClassName('test');
	// console.log(glass);
	for(var i=0;i<glass.length;i++)
	{
		glass[i].onmouseover=function(e)
		{
			...
			var l=this.parentNode.parentNode.offsetLeft;//其（glass）的父元素离开页面左上角的距离
			var t=this.parentNode.parentNode.offsetTop;//其（glass）的父元素离开页面左上角的距离
